...
localparam  PG_IDLE = 3'd0;
localparam  PG_LOAD = 3'd1;
localparam  PG_DEC_A = 3'd2;
localparam  PG_DEC_B = 3'd3;
...
cy_psoc3_dp8 #(.d0_init_a(23), .d1_init_a(1), 
.cy_dpconfig_a(
{
