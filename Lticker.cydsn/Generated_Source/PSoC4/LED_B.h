...
#define LED_B_DM_ALG_HIZ         (0x00u << LED_B_DRIVE_MODE_SHIFT)
#define LED_B_DM_DIG_HIZ         (0x01u << LED_B_DRIVE_MODE_SHIFT)
#define LED_B_DM_RES_UP          (0x02u << LED_B_DRIVE_MODE_SHIFT)
#define LED_B_DM_RES_DWN         (0x03u << LED_B_DRIVE_MODE_SHIFT)
#define LED_B_DM_OD_LO           (0x04u << LED_B_DRIVE_MODE_SHIFT)
#define LED_B_DM_OD_HI           (0x05u << LED_B_DRIVE_MODE_SHIFT)
#define LED_B_DM_STRONG          (0x06u << LED_B_DRIVE_MODE_SHIFT)
#define LED_B_DM_RES_UPDWN       (0x07u << LED_B_DRIVE_MODE_SHIFT)
